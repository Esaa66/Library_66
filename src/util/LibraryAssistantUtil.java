...
import PDF.ListToPDF;
import UI.settings.Preferences;
import UI.main.MainController;

public class LibraryAssistantUtil {

    public static final String ICON_IMAGE_LOC = "/library_resources/icon.png";
    public static final String MAIL_CONTENT_LOC = "/library_resources/mail_content.html";
