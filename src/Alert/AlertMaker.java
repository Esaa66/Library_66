...
public class AlertMaker {
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource(util.LibraryAssistantUtil.ICON_IMAGE_LOC));
    ...
    private static void styleAlert(Alert alert) {
        ...
        util.LibraryAssistantUtil.setStageIcon(stage);

        DialogPane dialogPane = alert.getDialogPane();
        dialogPane.getStylesheets().add(AlertMaker.class.getResource("/library_resources/dark-theme.css").toExternalForm());
