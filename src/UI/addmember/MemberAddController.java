...
public class MemberAddController implements Initializable {
    ...
    databaseHandlar.DatabaseHandler handler;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        handler = databaseHandlar.DatabaseHandler.getInstance();
    }
    ...
    private void handleUpdateMember() {
        ...
        if (databaseHandlar.DatabaseHandler.getInstance().updateMember(member)) {
