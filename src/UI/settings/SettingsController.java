...
import DB.export.DatabaseExporter;
import UI.mail.TestMailController;
...
public class SettingsController implements Initializable {
    ...
    private void handleTestMailAction(ActionEvent event) {
        ...
        if (mailServerInfo != null) {
            TestMailController controller = (TestMailController) LibraryAssistantUtil.loadWindow(getClass().getResource("/library_resources/assistant/ui/mail/test_mail.fxml"), "Test Email", null);
