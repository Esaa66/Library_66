...
import DB.databaseHandlar.DatabaseHandler;
...
public class MainController implements Initializable, BookReturnCallback {
    ...
    private void handleAboutMenu(ActionEvent event) {
        LibraryAssistantUtil.loadWindow(getClass().getResource("/library_resources/assistant/ui/about/about.fxml"), "About Me", null);
    }
    ...
    private void initDrawer() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/library_resources/assistant/ui/main/toolbar/toolbar.fxml"));
    ...
    private void handleMenuOverdueNotification(ActionEvent event) {
        LibraryAssistantUtil.loadWindow(getClass().getResource("/library_resources/assistant/ui/notifoverdue/overdue_notification.fxml"), "Notify Users", null);
    }
