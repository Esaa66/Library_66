...
public class BookAddController implements Initializable {
    ...
    private databaseHandlar.DatabaseHandler databaseHandler;
    private Boolean isInEditMode = Boolean.FALSE;

    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        databaseHandler = databaseHandlar.DatabaseHandler.getInstance();
    }
    ...
    private void checkData() {
        ...
        ResultSet rs = databaseHandlar.DatabaseHandler.getInstance().execQuery(qu);
        try {
            while (rs.next()) {
