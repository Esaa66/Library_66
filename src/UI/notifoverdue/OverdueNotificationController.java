...
import UI.notifoverdue.emailsender.EmailSenderController;
...
public class OverdueNotificationController implements Initializable {
    ...
    private void handleSendNotificationAction(ActionEvent event) {
        ...
        Object controller = LibraryAssistantUtil.loadWindow(getClass().getResource("/library_resources/assistant/ui/notifoverdue/emailsender/email_sender.fxml"), "Notify Overdue", null);
        if (controller != null) {
